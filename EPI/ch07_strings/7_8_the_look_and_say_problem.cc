 ...
 * to generate an entry of the sequence from the previous entry, read off the
 * digits of the previous entry, counting the number of digits in groups of the
 * same digit. For example,
 *
 * 1; one 1; two 1s; one 2 then one 1; one 1, then one 2, then two 1s;
